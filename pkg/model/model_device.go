...
// A Device represents a device available in the system
type Device struct {
...
// A DriverApiResponse represents a response produced by the Device Driver
type DriverApiResponse struct {
	Code    int    `json:"code,omitempty"`
	Message string `json:"message,omitempty"`
}

// A Device Driver stores information about available Device Driver services
...
// A FogNodeDevice represent a device connected to a Fog Node
...
// A BLECharacteristic represents a Bluetooth Low Energy Characteristic that can be read or written
...
// Triggers an action on a specific device on this Device Driver
